	...
	<div class="row">
		...
		<div class="col-lg-6">
			...
			<div class="jumbotron hoverable p-4">
					<form action="actualizar_foto1.php" method="POST" enctype="multipart/form-data">
						        <?php
      if (isset($_GET['error'])) {
        echo "<center><div class='alert alert-danger'>Primero debes guardar una fotografía!</div></center><br>";
      }
    
?>	
					<h4 class="display-4" align="center">Actualiza tu foto de perfil.</h4>
...
<div class="row">
  ...
  $o = "SELECT * FROM fotop WHERE mail = '$mail'";
  $e = $conexion->query($o);
  while ($w = mysqli_fetch_array($e)) {

  ?>
          
          <p><?php echo '<img src="data:image/png;base64,'.base64_encode($w['foto']). '"  class="mr-3 mt-3" style="width:100%;">'; ?></p>
    </div>
    ...
    <div class="col">
      ...
      <input type="file" name="foto" accept="image/png, .jpeg, .jpg, image/gif" class="btn"><br>
            ...
            <input type="submit" name="envia" value="Actualizar" class="btn btn-success">
          </form>
...
?>
<a href="perfil1.php" class="btn btn-danger">Regresar</a>
    </div>
</div>
