...
<!--/.Navbar -->
  ...
  <div class="row">
    ...
    <div class="col-lg-10 col-md-12">
      ...
      <center>
        <h1 class="h1-responsive font-weight-bold mt-sm-5">Mis compras</h1>
    	...
    	<br>
    	 <tr>
    	  <?php
    	  $con=0;
    	  $sql = $conexion->query("SELECT * FROM compras WHERE mpdc='$mpdc'");
...
<td>
  ...
  <div class="card-body card-body-cascade">
    ...
    <center>
    <p class="card-text"><h4>'.$row['cantidad'].'X$'.$row['costo'].'</h4></p>
    </center>
    <pclass="card-text">Tu paquete esta en camino</p>
  </div>
